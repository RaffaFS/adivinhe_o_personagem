...
export const tipsModule = [
    ...
    [
        ...
        'Sua marca registrada é salvar a todos com um sorriso no rosto',
        'Herói número um em My Hero Academia',
        'Símbolo da paz',
        'Mentor de Izuku Midoriya',
        'Oitavo portador do One For All',
        'Esconde uma forma enfraquecida',
        'Seu nome real é Toshinory Yagi',
        '"Se meter onde não for chamado, é a essencia para ser um super-herói"',
        '"Está tudo bem agora. Por que? Porque eu estou aqui!"'
    ],
    // Zenitsu Agatsuma
    [
        'Treinado pelo seu vô',
        'Não queria se tornar caçador de demônio',
        'Foi espancado por um javali',
        'Espadachin com pavor de aranhas',
        '"Respiração do trovão, primeira forma!"',
        'Especialista na Respiração do Trovão',
        'Apaixonado por Nezuko',
        'Se torna incrivelmente forte quando dorme',
        '"Se você só consegue fazer uma coisa, que seja o mestre nela"',
        'Ajudou Tanjiro a matar uma aranha'
    ],
    // Saber
    [
        '"Excalibur!"',
        ...
        'Seu Verdadeiro nome é Arthuria Pendragon',
        'Ela empunhou a espada da pedra, Caliburn'
    ],
    // Inosuke Hashibira
    [
        'Consegue saber a localização dos inimigos a partir da vibração da terra',
        '"Respiração da Fera, Terceira Forma!"',
        'Usa uma cabeça de javali',
        'Cresceu nas montanhas, criado por javalis',
        'Usa duas katanas quebradas',
        'Inicialmente quer matar a Nezuko',
        'Se contorce realocando seus ossos',
        'Chama o nome do Tanjiro errado',
        'Chorou apenas uma vez no anime',
        '"Ele me chamou de "Javali de uma figa", viu Monjiro"',
    ],
    // Shinji Ikari
    [
        '"Eu devo pilotar o Eva!"',
        '"Eu odeio meu pai!"',
        '"Punir-se é apenas um truque para sentir-se melhor por algum tempo"',
        '"O que há de errado em fugir da realidade se ela é uma droga"',
        'Protagonista de Neon Genesis Evangelion',
        'Filho do comandante da NERV',
        'Passa a viver com Misato e Asuka',
        'Piloto do Eva Unit-01',
        'Tem uma relação complicada com seu pai Gendo',
        'Luta contra os Anjos em um Mecha roxo',
    ],
    // Orochimaru
    [
        'Busca a imortalidade pelas marcas amaldiçoadas de seus subordinados',
        'Ex-membro da akatsuki e parceiro de Sasori',
        'Antagonista principal de Naruto Clássico',
        'Tem um passado como Sannin lendário de Konoha',
        'Tem várias Jutsus proibidas',
        'Tentou roubar o corpo de Itachi',
        '"Sasssssuke..."',
        'Foi treinado por, e matou Hiruzen Sarutobi (Terceiro Hokage)',
        'Mestre de Kabuto',
        'Fundou a vila oculta do som'
    ],
    // Satoru Gojo
    [
        '"Você não pode me tocar."',
        '"Vazio infinito!"',
        'Usa o poder do "Ilimitado" e do "Seis Olhos"',
        ...
        'Seu melhor amigo quer eliminar os não feiticeiros'
    ],
    // Yuji Itadori
    [
        'Protagonista de Jujutsu Kaisen',
        'Engole alguns dedos da maldição mais poderosa',
        'Animado primeiranista na Tokyo Jujutsu High',
        'Desenvolve habilidades de combate e exorcismo de maldições',
        'Um grande desejo seu é que em sua morte ele esteja cercado de pessoas queridas',
        'Nunca matou um inimigo. "Se eu matasse alguém, o valor de uma vida se tornaria ambíguo"',
        'Gojo: "mas checaram o pulso?"',
        'Arrancou o próprio coração enquanto dominado por uma maldição',
