...
export const tipsModule = [
    ...
    [
        ...
        'Mais conhecido pelo apelido "Kira"',
    ...
    // Meliodas
    [
        'Capitão dos sete pecados capitais',
        'Trabalha numa taberna chamada Chapéu de Javali',
        'Tem um porco chamado Hawk',
        'Loiro, baixinho, tarado e super poderoso',
        'Pecado da ira',
        'Extremamente poderoso e imortal',
        'Está preso em um ciclo de reencarnação',
        'Apaixonado por Elizabeth',
        'Inicialmente utiliza uma espada de lámina quebrada',
        'Tem a tatuagem de um dragão estilo "Oroboros" no braço esquerdo'
    ],
    // Kaneki Ken
    [
        'Meio humano meio Ghoul',
        '"Você tentou me devorar, então não poderá reclamar se eu o comer, não é?"',
        'Passa a trabalhar em e para a Anteiku',
        'Transformado em Ghoul após um acidente',
        'Luta contra sua nova identidade e natureza não totalmente humana',
        'Entra frequentemente em conflito com a CCG',
        'Seu olho revela segredos que ele não deseja que sejam conhecidos',
        'Luta usando tentáculos vermelhos',
        '"Oshiete, oshiete yo sono shikumi wo"',
        'Inicialmente passa a se nutrir apenas com café'
    ],
    // Gohan
    [
        'Irmão de Goten',
        ...
        'Derrotou seu adversário mais icônico com um kamehameha de uma mão',
        'Torna-se um guerreiro defensivo da Terra',
        'Também conhecido pelo alter ego de "Grande Saiyaman"',
        'Guerreiro de personalidade gentil e estudiosa',
        'Primeiro a se transformar em Super Saiyajin 2',
        'Casa-se com Videl',
        'Vem a ter uma filha chamada Pan'
    ],
    // Nezuko Kamado
    [
        'Seu sangue pega fogo a seu querer',
        'Vive dentro de uma caixa de madeira (inicialmente de um cesto)',
        'Quase morta por um Hashira',
        ...
        'Recupera sua vitalidade ao dormir (durante o dia)',
        'Tem um bamboo na boca',
        'Acordou um Hashira com uma cabeçada'
    ],
    // Mikasa Ackerman
    [
        '"Eu vou proteger o Eren a qualquer custo!"',
        '"Não quero perder a pequena família que me resta"',
        '"...... és su casa"',
        'Extremamente habilidosa em combate contra Titãs',
        'Tem uma ligação forte com Eren Yeager',
        'A única a ter as habilidades comparadas as de Levi',
        'Ganhou um cachecol vermelho de seu "novo irmão"',
        'Entrou no serviço militar para acompanhar proteger o irmão',
        'A mais jovem Ackerman',
        'Guerreira de feições orientais em um mundo de titãs'
    ],
    // L
    [
        ...
        'Detetive de aparência excêntrica',
        'Pensa melhor de cócoras',
        'Adora doces e bolo de morango',
        'Tem um forte senso de justiça',
        '"Primeira regra: eu nunca erro; Segunda: se eu errar volte para a primeira regra"',
        '"Conheço a estupidez humana e não quero me contagiar"',
        'Foi forçado a aparecer publicamente para resolver um caso'
    ],
    // Pain
    [
    ...
    // Gaara
    [
        '"Depois que eu conheci você descobri o verdadeiro significado da palavra amizade"',
    ...
    // Gon Freecss
    [
        '"Amigos podem seguir caminhos diferentes, mas continuam sendo amigos"',
    ...
    [
        ...
        'Usou a máscara de pedra',
        'Consegue parar o tempo com o poder: "The World"',
        'Rival de Jonathan Joestar'
    ],
    // Izuku Midoriya
    [
