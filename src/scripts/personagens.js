...
export const tipsModule = [
    ...
    [
        ...
        '"Eu não vou deixar você destruir o meu mundo!"',
        'Protagonista de Dragon Ball',
        'Tem um apetite insaciável',
        'Tinha um rabo quando era criança',
        'A sua luta mais icônica durou 19 episódios',
        'Viajou para o passado e se tornou criança',
    ...
    [
        ...
        'Pai de Himawari',
        'Protagonista do animê das 9 bijuus',
        'Já teve um crush numa menina de cabelo rosa',
        'Passa o animê inteiro em busca de seu melhor amigo'
    ],
    // Vegeta
    [
        '"Eu sou o príncipe dos Saiyajins!"',
        '"Isso é para você, Kakarotto!"',
        'Exemplo clássico de personagem orgulhoso',
        'Maior rival de Goku',
        'Inicialmente vilão, torna-se aliado dos Guerreiros Z',
        'Marido da Bulma',
        'Pai de Trunks',
        '"Você é um inseto insignificante"',
    ...
    [
        ...
        '"Odeio muitas coisas e não gosto de quase nada."',
        'Foi beijado pelo melhor amigo sem querer',
        'Maior rival e amigo de Naruto',
        'Último sobrevivente do massacre Uchiha',
        'Busca vingança contra seu irmão',
        'Despertou o magenkyou após descobrir a verdade sobre a morte do irmão',
        'Torna-se um ninja renegado',
        'Pai de Sarada',
        'Ele já teve uma marca amaldiçoada',
        'Tem o Sharingan o Rinnegan e uma espada',
        'Aprendiz do cara das cobras'
    ],
    // Monkey D. Luffy
    [
        ...
        'Tem o poder da fruta Gomu Gomu no mi',
        'Sonha em encontrar o One Piece',
        'Amigo do cabelo verde',
        'Pirata de borracha',
        '"Saanji, quero comida!"',
    ...
    [
        ...
        'Carregou uma enorme pedra para tapar um buraco',
    ...
    [
        ...
        'Escolhe o momento e a maneira da morte das pessoas',
        'Desenvolve uma rivalidade com o detetive L',
        'Deus do novo mundo!',
        'Classico manipulador e estrategista do mundo dos animês'
    ],
    // Saitama
    [
        '"Eu sou apenas um herói por hobby."',
        '"Sequência de Socos sério!"',
        '"Eu estou entediado..."',
        'Careca',
        '"Quer dizer... que hoje é... DIA DE PROMOÇÃO NO MERCADO!"',
        'Herói mais forte do mundo',
        'Derrota qualquer oponente com um soco',
        'Tem um amigo ciborgue',
        'Não recebe o reconhecimento que merece da associação de heróis',
    ...
    [
        ...
        '"Protagonista do animê da quimera"'
    ],
    // Spike Spiegel
    [
        '"Bang."',
        ...
        'Caçador de recompensas que voa pelo espaço',
        'Ex-membro do sindicato criminoso Red Dragon',
        'Extremamente habilidoso na pilotagem da sua nave',
    ...
    [
        ...
        'Kunoichi "inútil" da Vila da Folha',
        'Esposa de um Uchiha',
        'Desenvolve habilidades médicas e de combate',
        'Aprendiz de uma hokage',
        'Kunoichi de força física descomunal',
        'Integrante feminina do time 7',
        'Corta seu cabelo com uma kunai na floresta da morte',
        'Aprendeu com sua mestra a invocar uma "lesma"'
    ],
    // Levi Ackerman
    [
