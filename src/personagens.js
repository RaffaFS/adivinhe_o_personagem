...
export const tipsModule = [
    ...
    [
        '"Kamehameha!"',
        '"Eu sou o Saiyajin que veio da Terra para te derrotar!"',
        '"Eu não sou um herói, mas vou lutar por justiça!"',
        'Protagonista de Dragon Ball',
        'Sempre busca se tornar mais forte',
        'Acredita na bondade das pessoas',
        'Tem um apetite insaciável',
        'Ama lutar e desafios',
        'É amigo de muitos de seus antigos inimigos',
        'Pai de Gohan e Goten',
        'Marido de Chi-Chi'
    ],
    // Uzumaki Naruto
    [
        ...
        'Portador da Nove Caudas (Kurama)',
        'Determinado a ser reconhecido pela aldeia',
        'Tem um forte senso de justiça',
        'Amigo leal e protetor',
        'Torna-se um dos ninjas mais poderosos',
        'Marido de Hinata e pai de Boruto e Himawari'
    ],
    // Vegeta
    [
        '"Eu sou o príncipe dos Saiyajins!"',
        '"Isso é para você, Kakarotto!"',
        '"Ninguém se atreve a me desafiar!"',
        'Maior rival de Goku',
        'Príncipe dos Sayajins',
        'Orgulhoso e determinado',
        'Inicialmente vilão, torna-se aliado dos Z Warriors',
        'Marido da Bulma e pai de Trunks e Bra',
        'Sempre busca superar Goku',
        'Tem uma rivalidade amigável com Goku',
        'Possui um forte senso de honra'
    ],
    // Uchiha Sasuke
    [
        '"Eu vou restaurar meu clã e matar certo alguém!"',
        '"Meu nome é Sasuke Uchiha. Odeio muitas coisas e não gosto de quase nada."',
        '"Eu ando um caminho diferente do de você, Naruto."',
        'Rival e amigo de Naruto',
        'Último sobrevivente do massacre Uchiha',
        'Busca vingança contra seu irmão Itachi',
        'Extremamente habilidoso e talentoso',
        'Torna-se um ninja renegado',
        'Casa-se com Sakura e tem uma filha chamada Sarada',
        'Tem o Sharingan e o Rinnegan',
        'Seu objetivo é criar um mundo melhor'
    ],
    // Monkey D. Luffy
    [
        ...
        'Tem o poder da fruta Gomu Gomu',
        'Sonha em encontrar o One Piece',
        'Tem um forte senso de justiça e amizade',
        'Sempre pronto para aventuras e desafios',
        'Incrivelmente resiliente e otimista',
        'Amigo leal e protetor'
    ],
    // Eren Yeager
    [
        ...
        'Determinado a destruir todos os Titãs',
        'Possui o poder do Titã de Ataque',
        'Impulsivo e ferozmente determinado',
        'Deseja a liberdade para sua gente',
        'Tem uma forte vontade de proteger seus amigos',
        'Conflituoso sobre sua própria humanidade'
    ],
    // Light Yagami
    [
        '"Eu sou a justiça!"',
        ...
        'Encontra um caderno mortal chamado Death Note',
        'Adota o pseudônimo de Kira',
        'Busca eliminar criminosos para criar um mundo ideal',
        'Extremamente inteligente e calculista',
        'Desenvolve uma rivalidade com o detetive L',
        'Sua moralidade se torna questionável',
        'Manipulador e estrategista'
    ],
    // Saitama
    [
        '"Eu sou apenas um herói por hobby."',
        '"Sério soco!"',
        '"Eu estou entediado..."',
        'Protagonista de One Punch Man',
        'Herói mais forte do mundo',
        'Derrota qualquer oponente com um soco',
        'Sempre em busca de uma luta desafiadora',
        'Mantém uma personalidade despreocupada',
        'Não recebe o reconhecimento que merece',
        'Treinou tanto que perdeu todo o cabelo',
        'Tem um forte senso de justiça e dever'
    ],
    // Edward Elric
    [
        '"Não chamem de baixinho!"',
        '"Para obter, algo de igual valor deve ser perdido."',
        '"Eu vou recuperar o corpo do meu irmão, custe o que custar!"',
        'Protagonista de Fullmetal Alchemist',
        'Alquimista Federal mais jovem',
        'Perdeu um braço e uma perna em uma transmutação humana falhada',
        'Busca a Pedra Filosofal para restaurar seu corpo e o de seu irmão',
        'Extremamente talentoso em alquimia',
        'Irmão mais velho de Alphonse Elric',
    ...
    [
        ...
        'Protagonista de Cowboy Bebop',
        'Caçador de recompensas',
        'Ex-membro do sindicato criminoso Red Dragon',
        'Tem um passado misterioso',
        'Extremamente habilidoso em combate',
        'Calmo e descontraído, mas letal',
        'Tem uma relação complexa com Julia e Vicious',
        'Amigo e parceiro de Jet Black'
    ],
    // Sakura Haruno
    [
        '"Eu vou me tornar uma ninja poderosa!"',
        '"Sasuke-kun!"',
        '"Eu não sou mais aquela Sakura de antes!"',
        'Kunoichi da Vila da Folha',
        'Inicialmente focada em Sasuke Uchiha',
        'Desenvolve habilidades médicas e de combate',
        'Tem uma personalidade gentil e determinada',
        'Busca provar seu valor como uma ninja forte',
        'Desenvolve laços profundos com Naruto e Sasuke',
        'Participa de várias missões e batalhas',
        'Mostra um crescimento significativo ao longo da série'
    ],
    // Levi Ackerman
    [
    ...
    [
        ...
        '"Eu não vou deixar ninguém machucar meus amigos!"',
        'Protagonista de The Seven Deadly Sins',
        'Líder dos Sete Pecados Capitais',
        'Extremamente poderoso e imortal',
        'Tem uma aparência jovem, mas é muito velho',
        'Apaixonado por Elizabeth',
        'Busca redimir seus pecados passados',
        'Tem um forte senso de liderança e proteção',
        'Possui um poder demoníaco assustador'
    ],
    // Kaneki Ken
    [
        '"Eu sou um Ghoul!"',
        '"Eu vou proteger aqueles que amo!"',
        '"Eu não sou mais humano."',
        'Protagonista de Tokyo Ghoul',
        'Transformado em Ghoul após um acidente',
        'Luta contra sua nova identidade e natureza',
        'Busca um equilíbrio entre humano e Ghoul',
        'Extremamente poderoso e resiliente',
        'Tem um forte senso de justiça e proteção',
        'Desenvolve uma personalidade mais sombria',
        'Luta para proteger seus amigos e entes queridos'
    ],
    // Gohan
    [
        '"Eu sou filho do Goku!"',
        '"Eu vou proteger a Terra!"',
        '"Eu não vou deixar ninguém machucar meus amigos!"',
        'Filho mais velho de Goku',
        'Meio Saiyajin, meio humano',
        'Extremamente poderoso e talentoso',
        'Torna-se um guerreiro defensivo da Terra',
        'Luta para proteger sua família e amigos',
        'Tem uma personalidade gentil e estudiosa',
        'Transforma-se em Super Saiyajin e Super Saiyajin 2',
        'Casa-se com Videl e tem uma filha chamada Pan'
    ],
    // Nezuko Kamado
    [
        '"Eu vou proteger meu irmão!"',
        '"Eu não sou mais humana, mas ainda posso lutar!"',
        '"Eu não vou deixar os demônios vencerem!"',
        'Irmã de Tanjiro Kamado',
        'Transformada em demônio, mas mantém traços humanos',
        'Luta ao lado de seu irmão para exterminar demônios',
        'Tem habilidades demoníacas únicas',
        'Extremamente leal e protetora de seu irmão',
        'Consegue resistir à sua natureza demoníaca',
        'Usa seu poder para proteger os inocentes',
        'Tem uma forte ligação com Tanjiro'
    ],
    // Mikasa Ackerman
    [
        '"Eu vou proteger Eren a qualquer custo!"',
        '"Eu não deixarei ninguém machucar aqueles que amo!"',
        '"Eu sou uma Ackerman!"',
        'Protagonista de Attack on Titan',
        'Extremamente habilidosa em combate contra Titãs',
        'Tem uma ligação forte com Eren Yeager',
        'Perdeu seus pais em um ataque',
        'Tem um forte senso de dever e proteção',
        'Parte da Tropa de Exploração',
        'Resiliente e determinada',
        'Busca vingar a morte de seus entes queridos'
    ],
    // L
    [
        '"Eu sou L."',
        '"Justiça prevalecerá."',
        '"Eu não perco."',
        'Principal detetive de Death Note',
        'Extremamente inteligente e calculista',
        'Rivaliza com Kira (Light Yagami)',
        'Usa métodos não convencionais de investigação',
        'Tem uma aparência excêntrica',
        'Adora doces',
        'Tem um forte senso de justiça',
        'Identidade e passado são misteriosos'
    ],
    // Pain
    [
        '"Eu sou o Deus deste mundo."',
        '"A dor é a única maneira de trazer paz."',
        '"Eu vou criar um mundo sem sofrimento."',
        'Líder da Akatsuki',
        'Manipula os Seis Caminhos da Dor',
        'Busca a paz através do sofrimento',
        'Antigo discípulo de Jiraiya',
        'Tem um passado trágico e doloroso',
        'Controlado por Nagato',
        'Extremamente poderoso e temível',
        'Busca destruir Konoha para atingir seus objetivos'
    ],
    // Madara
    [
        '"Eu sou Madara Uchiha!"',
        '"O mundo real é um inferno."',
        '"Eu vou criar um mundo de paz eterna."',
        'Fundador do Clã Uchiha',
        'Antagonista de Naruto',
        'Busca dominar o mundo shinobi',
        'Extremamente poderoso e temível',
        'Habilidoso com o Sharingan e Rinnegan',
        'Revive durante a Quarta Guerra Mundial Shinobi',
        'Tem uma rivalidade antiga com Hashirama Senju',
        'Deseja criar um mundo de sonhos através do Tsukuyomi Infinito'
    ],
    // Gaara
    [
        '"Eu nunca perdoarei ninguém que me machuque."',
        '"Eu luto apenas por mim mesmo."',
        '"Eu não sou um monstro!"',
        'Kazekage da Vila da Areia',
        'Portador do Shukaku (Uma Cauda)',
        'Tem um passado traumático e solitário',
        'Inicialmente vilão, torna-se aliado',
        'Desenvolve um forte senso de dever',
        'Busca proteger sua vila e amigos',
        'Tem uma habilidade única de manipular areia',
        'Transforma-se em um líder respeitado e amado'
    ],
    // Subaru Natsuki
    [
        '"Eu vou salvar todos!"',
        '"Eu vou mudar meu destino."',
        '"Mesmo que eu morra, eu vou voltar."',
        'Protagonista de Re:Zero',
        'Possui a habilidade de "Retorno pela Morte"',
        'Determinado a proteger Emilia',
        'Revive após cada morte para corrigir erros',
        'Desenvolve uma forte resiliência emocional',
        'Luta contra suas próprias fraquezas',
        'Tem uma vontade inabalável de mudar o futuro',
        'Cria fortes laços de amizade e lealdade'
    ],
    // Gon Freecss
    [
        ...
        'Possui uma força e determinação incríveis',
        'Tem um senso de aventura e curiosidade',
        'Forma uma amizade forte com Killua',
        'Aprende e domina o uso do Nen',
        'Participa de várias provas e batalhas',
        'Sempre busca fazer o que é certo'
    ],
    // Killua Zoldyck
    [
        '"Eu vou proteger Gon!"',
        ...
        'Extremamente habilidoso e treinado desde jovem',
        'Busca sua própria identidade fora da família',
        'Tem um forte senso de amizade e lealdade',
        'Desenvolve habilidades especiais de Nen',
        'Luta para proteger seus amigos',
        'Tem uma personalidade complexa e evolutiva'
    ],
    // Dio Brando
    [
        ...
        'Vampiro imortal e extremamente poderoso',
        'Usa o Stand "The World"',
        'Tem uma rivalidade com a família Joestar',
        'Busca dominação mundial e poder absoluto',
        'Manipulador e sem escrúpulos',
        'É conhecido por sua crueldade e ambição',
    ...
    [
        ...
        '"Eu vou proteger todos!"',
        '"Eu posso fazer isso!"',
        'Protagonista de My Hero Academia',
        'Recebe o poder do One For All de All Might',
        'Inicialmente sem individualidade (quirk)',
        'Determinado a se tornar o maior herói',
        'Tem um forte senso de justiça e compaixão',
        'Treina arduamente para controlar seus poderes',
        'Forma amizades fortes na U.A. High School',
        'Sempre busca salvar e proteger os outros'
    ],
    // All Might
    [
        '"Eu estou aqui!"',
        '"Você também pode se tornar um herói!"',
        '"Poder para salvar todos com um sorriso!"',
        'Herói número um em My Hero Academia',
        'Símbolo da paz e justiça',
        'Mentor de Izuku Midoriya',
        'Usa o poder do One For All',
        'Tem uma personalidade carismática e inspiradora',
        'Esconde uma forma enfraquecida',
        'Sempre busca inspirar esperança',
        'Sua presença traz segurança e confiança'
    ],
    // Zenitsu Agatsuma
    [
        '"Eu vou proteger Nezuko!"',
        '"Eu só tenho medo porque sou forte!"',
        '"Trovão, Respiração do Primeiro Estilo!"',
        'Membro da Demon Slayer Corps',
        'Especialista na Respiração do Trovão',
        'Inicialmente covarde e medroso',
        'Desenvolve coragem para proteger seus amigos',
        'Tem um forte senso de lealdade e amizade',
        'Apaixonado por Nezuko',
        'Se torna incrivelmente forte quando inconsciente',
        'Busca sempre melhorar suas habilidades'
    ],
    // Saber
    [
        '"Eu sou o rei que guarda o futuro!"',
        '"Eu vou proteger meus ideais!"',
        '"Excalibur!"',
        'Serva na série Fate',
        'Rei Arthur reencarnado',
        'Extremamente habilidosa e poderosa',
        'Busca o Santo Graal para salvar sua pátria',
        'Tem um forte senso de honra e dever',
        'Desenvolve uma relação com Shirou Emiya',
        'Luta com a espada Excalibur',
        'Determinação inabalável'
    ],
    // Inosuke Hashibira
    [
        '"Eu sou o mais forte!"',
        '"Eu vou vencer qualquer um!"',
        '"Respiração da Fera, Primeira Forma!"',
        'Membro da Demon Slayer Corps',
        'Cresceu nas montanhas, criado por javalis',
        'Extremamente forte e ágil',
        'Tem uma personalidade agressiva e competitiva',
        'Usa duas espadas serrilhadas',
        'Desenvolve um senso de camaradagem',
        'Sempre busca desafios e lutas',
        'Aprimora constantemente suas habilidades'
    ],
    // Inuyasha
    [
        '"Eu sou meio-demônio!"',
        '"Eu vou proteger todos!"',
        '"Tessaiga!"',
        'Protagonista de Inuyasha',
        'Meio-demônio, meio-humano',
        'Busca a Jóia de Quatro Almas',
        'Tem uma relação complexa com Kagome',
        'Extremamente forte e habilidoso',
        'Usa a espada Tessaiga',
        'Luta contra vários demônios e vilões',
        'Tem um forte senso de justiça e proteção'
    ],
    // Shinji Ikari
    [
        ...
        'Piloto do Eva Unit-01',
        'Tem uma relação complicada com seu pai Gendo',
        'Luta contra os Anjos para proteger a Terra',
        'Extremamente introspectivo e emocional',
        'Busca aceitação e significado',
        'Desenvolve relações complexas com outros pilotos',
        'Tem uma personalidade introvertida e conflituosa'
    ],
    // Orochimaru
    [
        '"Eu busco a imortalidade!"',
        '"Eu vou aprender todos os jutsus!"',
        '"Eu não tenho limites!"',
        'Ex-membro da Akatsuki',
        'Antagonista principal de Naruto',
        'Busca a imortalidade e conhecimento absoluto',
        'Extremamente habilidoso e inteligente',
        'Tem um passado como Sannin lendário de Konoha',
        'Realiza experimentos humanos sombrios',
        'Tem várias habilidades proibidas',
        'Busca sempre mais poder e conhecimento'
    ],
    // Satoru Gojo
    [
        '"Eu sou o mais forte!"',
        ...
        '"Infinito Azul!"',
        'Professor na Tokyo Jujutsu High',
        'Considerado o feiticeiro mais poderoso',
        'Tem habilidades de controle espacial',
        'Mentor de Yuuji Itadori',
        'Tem uma personalidade despreocupada',
    ...
    [
        ...
        '"Eu vou exorcizar todas as maldições!"',
        'Protagonista de Jujutsu Kaisen',
        'Tem uma força física incrível',
        'Ingesta o dedo de Sukuna e ganha seus poderes',
        'Determinado a proteger seus amigos e inocentes',
        'Estudante na Tokyo Jujutsu High',
        'Desenvolve habilidades de exorcismo e combate',
        'Tem uma personalidade altruísta e corajosa',
        'Busca sempre fazer o bem'
    ],
    // Erza Scarlet
    [
        '"Eu sou a Titania!"',
